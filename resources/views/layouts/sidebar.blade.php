...
>
    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden py-2 px-2 space-y-0.5 w-60">
        ...
        >
            <x-sb-link :href="route('sales.create')"    :active="request()->routeIs('sales.create')"               label="Empleados"   />
        ...
        <x-sb-dropdown
            label="Compras"
            icon="shopping-cart"
            :active="request()->routeIs(['purchases.*', 'suppliers.*'])"
        >
        ...
        <x-sb-dropdown
            label="Productos"
            icon="cube"
            :active="request()->routeIs(['products.*', 'categories.*', 'units.*'])"
        >
